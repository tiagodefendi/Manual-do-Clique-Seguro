...
O Manual do Clique Seguro é um **Objeto de Aprendizagem** desenvolvido com intuito de ensinar boas práticas de cibersegurança para idosos que acessam a internet. O projeto consiste em uma aplicação web construída com Next.js e NestJS, que oferece uma interface amigável e acessível para os usuários interagirem com conteúdos educacionais, quizzes interativos e monitoramento de progresso.
